...
export const DataQuestions = [
	...
	{
		title: '¿Qué factores debo considerar al elegir una agencia de desarrollo web?',
		text: 'Al elegir una agencia de desarrollo web, es importante considerar su experiencia, su portafolio de proyectos anteriores, la calidad de su trabajo, los servicios que ofrecen, su enfoque en el diseño responsivo y la optimización SEO, así como la atención al cliente y el soporte post-venta. Asegúrate de buscar una agencia que pueda cumplir con tus necesidades específicas y que esté comprometida con tu éxito en línea.'
	}
]
